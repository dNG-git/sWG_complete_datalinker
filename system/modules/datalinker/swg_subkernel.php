...
----------------------------------------------------------------------------
$Id: swg_subkernel.php,v 1.2 2009/01/01 13:14:37 s4u Exp $
#echo(sWGdatalinkerVersion)#
sWG/#echo(__FILEPATH__)#
----------------------------------------------------------------------------
NOTE_END //n*/
/**
* Subkernel for: datalinker
*
* @internal   We are using phpDocumentor to automate the documentation process
*             for creating the datalinker's Manual. All sections including
...
if (!defined ("CLASS_direct_subkernel_datalinker"))
{
//c// direct_subkernel_datalinker
/**
* Subkernel for: datalinker
*
* @author     direct Netware Group
...
*             GNU General Public License 2
*/
class direct_subkernel_datalinker extends direct_virtual_class
{
/* -------------------------------------------------------------------------
Extend the class
------------------------------------------------------------------------- */

	//f// direct_subkernel_datalinker->__construct ()
/**
	* Constructor (PHP5) __construct (direct_subkernel_datalinker)
	*
...
*/
	...
	{
		if (USE_debug_reporting) { direct_debug (5,"sWG/#echo(__FILEPATH__)# -kernel_class->__construct (direct_subkernel_datalinker)- (#echo(__LINE__)#)"); }
	...
	public function subkernel_init ($f_threshold_id = "")
	{
		...
		if (empty ($f_return))
		{
			if ($direct_classes['db']->v_connect ())
			{
				...
				if (!$direct_classes['basic_functions']->settings_get ($direct_settings['path_data']."/settings/swg_datalinker.php")) { $f_return = array ("core_required_object_not_found","FATAL ERROR:<br />&quot;$direct_settings[path_data]/settings/swg_datalinker.php&quot; was not found<br /><br />sWG/#echo(__FILEPATH__)# -kernel_class->subkernel_init ()- (#echo(__LINE__)#)"); }
			}
...
$direct_classes['@names']['subkernel_datalinker'] = "direct_subkernel_datalinker";
define ("CLASS_direct_subkernel_datalinker",true);

//j// Script specific commands

direct_class_init ("subkernel_datalinker");
$direct_classes['kernel']->v_call_set ("v_subkernel_init",$direct_classes['subkernel_datalinker'],"subkernel_init");
}
